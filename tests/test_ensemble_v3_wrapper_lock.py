"""Regression tests for the E6-v3 wrapper's persistent execution lock."""
...
WRAPPER = ROOT / "scripts" / "run_ensemble_bigmem_v3.sbatch"


def _sandboxed_wrapper(tmp_path: Path) -> tuple[Path, Path, Path]:
    ...
    script.chmod(0o700)
    lock = run_root / "runtime" / "v3" / "ensemble_v3.lock"
